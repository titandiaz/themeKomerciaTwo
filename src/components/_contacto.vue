...
export default {
  ...
  methods: {
    submitContact() {
      ...
      axios
        .post(`${this.$urlHttp}/api/front/mensaje-contacto`, json)
        .then(() => {
          this.nombre = "";
          this.email = "";
          this.numberphone = "";
          ...
          this.$store.state.id = "";
          this.messageAction(
            "Muy pronto te estaremos respondiendo a tu correo"
          );
        });
    },
...
.map_degrade {
  ...
  background: -moz-radial-gradient(
    ...
    rgba(192, 202, 51, 0.74) 45%,
    rgba(192, 202, 51, 1) 61%
  );
  background: -webkit-gradient(
    ...
    color-stop(45%, rgba(192, 202, 51, 0.74)),
    color-stop(61%, rgba(192, 202, 51, 1))
  );
